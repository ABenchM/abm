package de.fraunhofer.abm.builder.docker.sbt.steps;
...
public class RunDockerBuild extends AbstractDockerStep<String> {
    ...
    public RunDockerBuild(RepositoryDTO repo, ExecutorService executor, File repoDir) {
        ...
        this.name = "Run docker sbt build";
    }
    ...
    public String execute() {
        ...
        try {
            ...
            Result result = exec("docker run -v IVY_REPO:/root/.ivy2 --name " + containerName + " " + imageName + " clean package", repoDir);
