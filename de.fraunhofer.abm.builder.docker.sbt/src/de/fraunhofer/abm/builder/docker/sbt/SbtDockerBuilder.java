...
import de.fraunhofer.abm.builder.docker.sbt.steps.ExtractBuildResults;
import de.fraunhofer.abm.builder.docker.sbt.steps.RunDockerBuild;
import de.fraunhofer.abm.domain.RepositoryDTO;

public class SbtDockerBuilder extends AbstractProjectBuilder {
    ...
    public void init(RepositoryDTO repo, File repoDir) {
        ...
        Bundle sourceBundle = FrameworkUtil.getBundle(SbtDockerBuilder.class);
        ...
        try {
            ...
            if(state == STATE.CONTINUE) {
                ...
                if(extractBuildResults.getStatus() != STATUS.SUCCESS) {
                    ...
                    buildArtifacts.add(new File(repoDir, "sbt"));
                }
            }
        } finally {
            // clean up
