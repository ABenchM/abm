...
import de.fraunhofer.abm.builder.docker.maven.steps.ExtractBuildResults;
import de.fraunhofer.abm.builder.docker.maven.steps.RunDockerBuild;
import de.fraunhofer.abm.domain.RepositoryDTO;

public class MavenDockerBuilder extends AbstractProjectBuilder {
    ...
    public void init(RepositoryDTO repo, File repoDir) {
        ...
        Bundle sourceBundle = FrameworkUtil.getBundle(MavenDockerBuilder.class);
