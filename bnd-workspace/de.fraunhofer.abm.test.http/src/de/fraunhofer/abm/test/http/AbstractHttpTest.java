...
public abstract class AbstractHttpTest implements TestParameters {
    ...
    public void login(final String user, final String password) throws IOException {
        ...
        if(response.getResponseCode() == NUM200) {
    ...
    protected Map<String, String> createCollection() throws IOException {
        ...
        String payload = "{\"name\":\"slf4j\",\"description\":\"Simple Logging Facade 4 Java\",\"versions\":[{\"number\":1,\"creationDate\":\""
        		+ "2017-02-22T14:45:04.028Z\",\"comment\":\"Initial Version\",\"commits\":[{\"commitId\":\"HEAD\",\"repository\":{\"commits\""
        		+ ":null,\"commitsUrl\":\"https://api.github.com/repos/qos-ch/slf4j/commits{/sha}\",\"contentsUrl\":\""
    ...
    protected JSONObject getCollection(final Map<String, String> headers) throws IOException {
    ...
    protected void deleteCollection(final Map<String, String> headers, final String id) throws IOException {
