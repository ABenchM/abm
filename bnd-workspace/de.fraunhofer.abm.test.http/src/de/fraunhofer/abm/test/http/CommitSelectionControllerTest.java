...
public class CommitSelectionControllerTest extends AbstractHttpTest {
    ...
    public void unauthorizedPostCommitsShouldThrowException() throws IOException {
        ...
        String payload = "{\"page\":1,\"repository\":{\"commits\":[\"60c0477a-eed1-49d5-be82-680012ade77d\",\"7a7ef745-3222-4374-a758-8765a1090249\""
        		...
        		+ "description\":\"License\",\"id\":\"1b890a77-4dc2-3997-8cf3-3a187fd7f0d9\",\"name\":\"license\",\"repositoryId\":\""
        		+ "1c1dfb8c-2632-3346-9f33-8af508cba47d\",\"value\":\"BSD3CLAUSE\"},{\"description\":\"Built with Apache Maven\",\"id\":\""
        		+ "3160504c-062a-3493-ade2-361dff611ed5\",\"name\":\"build.system\",\"repositoryId\":\"1c1dfb8c-2632-3346-9f33-8af508cba47d\",\""
        		+ "value\":\"maven\"},{\"description\":\"Number of files in the project\",\"id\":\"362272eb-e1d2-36d5-aadb-3fb70ea3159a\",\"name\""
        		+ ":\"files\",\"repositoryId\":\"1c1dfb8c-2632-3346-9f33-8af508cba47d\",\"value\":\"211\"},{\"description\":\""
        		+ "Programming language java\",\"id\":\"fdb45ab4-305b-36ae-8cb6-d8668f0237df\",\"name\":\"language\",\"repositoryId\":\""
        		+ "1c1dfb8c-2632-3346-9f33-8af508cba47d\",\"value\":\"java\"}],\"releasesUrl\":\""
        		+ "https://api.github.com/repos/hampelratte/svdrp4j/releases{/id}\",\"remoteId\":2490885,\"repositoryType\":\"git\",\""
    ...
    public void postCommitsShouldReturnAList() throws IOException {
        ...
        String payload = "{\"page\":1,\"repository\":{\"commits\":[\"60c0477a-eed1-49d5-be82-680012ade77d\",\"7a7ef745-3222-4374-a758-8765a1090249\""
        		...
        		+ "3160504c-062a-3493-ade2-361dff611ed5\",\"name\":\"build.system\",\"repositoryId\":\"1c1dfb8c-2632-3346-9f33-8af508cba47d\",\""
        		+ "value\":\"maven\"},{\"description\":\"Number of files in the project\",\"id\":\"362272eb-e1d2-36d5-aadb-3fb70ea3159a\",\"name\":\""
        		+ "files\",\"repositoryId\":\"1c1dfb8c-2632-3346-9f33-8af508cba47d\",\"value\":\"211\"},{\"description\":\"Programming language java\""
        		+ ",\"id\":\"fdb45ab4-305b-36ae-8cb6-d8668f0237df\",\"name\":\"language\",\"repositoryId\":\"1c1dfb8c-2632-3346-9f33-8af508cba47d\""
        		+ ",\"value\":\"java\"}],\"releasesUrl\":\"https://api.github.com/repos/hampelratte/svdrp4j/releases{/id}\",\"remoteId\":2490885,\""
        		+ "repositoryType\":\"git\",\"repositoryUrl\":\"https://github.com/hampelratte/svdrp4j.git\",\"score\":25,\"size\":1458,\"starred\""
        		+ ":3,\"watched\":3}}";
        HttpResponse resp = HttpUtils.post(uri, headers, payload.getBytes(), charset);
        Assert.assertEquals(NUM200, resp.getResponseCode());
        JSONArray list1 = new JSONArray(resp.getContent());
        Assert.assertTrue(list1.length() > 0);

        payload = "{\"page\":2,\"repository\":{\"commits\":[\"60c0477a-eed1-49d5-be82-680012ade77d\",\"7a7ef745-3222-4374-a758-8765a1090249\"],\""
        		+ "commitsUrl\":\"https://api.github.com/repos/hampelratte/svdrp4j/commits{/sha}\",\"contentsUrl\":\""
        		+ "https://api.github.com/repos/hampelratte/svdrp4j/contents/{+path}\",\"contributorsUrl\":\""
        		+ "https://api.github.com/repos/hampelratte/svdrp4j/contributors\",\"creationDate\":\"2011-09-30T17:49:23\",\"defaultBranch\":\""
        		+ "master\",\"description\":\"An implementation of the Simple VDR Protocol.\",\"forks\":1,\"hasDownloads\":true,\"hasWiki\":true,\""
    ...
    public void unknownCrawlerShouldReturnAnEmptyCommitList() throws IOException {
        ...
        String payload = "{\"page\":1,\"repository\":{\"commits\":[\"60c0477a-eed1-49d5-be82-680012ade77d\",\"7a7ef745-3222-4374-a758-8765a1090249\""
        		...
        		+ ",\"id\":\"fdb45ab4-305b-36ae-8cb6-d8668f0237df\",\"name\":\"language\",\"repositoryId\":\"1c1dfb8c-2632-3346-9f33-8af508cba47d\""
        		+ ",\"value\":\"java\"}],\"releasesUrl\":\"https://api.github.com/repos/hampelratte/svdrp4j/releases{/id}\",\"remoteId\":2490885,\""
        		+ "repositoryType\":\"git\",\"repositoryUrl\":\"https://foobar.com/hampelratte/svdrp4j.git\",\"score\":25,\"size\":1458,\"starred\""
        		+ ":3,\"watched\":3}}";
        HttpResponse resp = HttpUtils.post(uri, headers, payload.getBytes(), charset);
        Assert.assertEquals(NUM200, resp.getResponseCode());
        JSONArray list1 = new JSONArray(resp.getContent());
    ...
    public void unknownCrawlerShouldReturnAnEmptyBranchList() throws IOException {
        ...
        String payload = "{\"page\":1,\"repository\":{\"commits\":[\"60c0477a-eed1-49d5-be82-680012ade77d\",\"7a7ef745-3222-4374-a758-8765a1090249\""
        		...
        		+ "1c1dfb8c-2632-3346-9f33-8af508cba47d\",\"value\":\"java\"}],\"releasesUrl\":\""
        		+ "https://api.github.com/repos/hampelratte/svdrp4j/releases{/id}\",\"remoteId\":2490885,\"repositoryType\":\"git\",\""
        		+ "repositoryUrl\":\"https://foobar.com/hampelratte/svdrp4j.git\",\"score\":25,\"size\":1458,\"starred\":3,\"watched\":3}}";
        HttpResponse resp = HttpUtils.post(uri, headers, payload.getBytes(), charset);
        Assert.assertEquals(NUM200, resp.getResponseCode());
        JSONArray list1 = new JSONArray(resp.getContent());
        Assert.assertTrue(list1.length() == 0);
    ...
    public void postTagsShouldReturnAList() throws IOException {
        ...
        String payload = "{\"page\":1,\"repository\":{\"commits\":[\"60c0477a-eed1-49d5-be82-680012ade77d\",\"7a7ef745-3222-4374-a758-8765a1090249\""
        		...
        		+ "1c1dfb8c-2632-3346-9f33-8af508cba47d\",\"value\":\"BSD3CLAUSE\"},{\"description\":\"Built with Apache Maven\",\"id\":\""
        		+ "3160504c-062a-3493-ade2-361dff611ed5\",\"name\":\"build.system\",\"repositoryId\":\"1c1dfb8c-2632-3346-9f33-8af508cba47d\",\""
        		+ "value\":\"maven\"},{\"description\":\"Number of files in the project\",\"id\":\"362272eb-e1d2-36d5-aadb-3fb70ea3159a\",\""
        		+ "name\":\"files\",\"repositoryId\":\"1c1dfb8c-2632-3346-9f33-8af508cba47d\",\"value\":\"211\"},{\"description\":\""
        		+ "Programming language java\",\"id\":\"fdb45ab4-305b-36ae-8cb6-d8668f0237df\",\"name\":\"language\",\"repositoryId\":\""
        		+ "1c1dfb8c-2632-3346-9f33-8af508cba47d\",\"value\":\"java\"}],\"releasesUrl\":\""
        		+ "https://api.github.com/repos/hampelratte/svdrp4j/releases{/id}\",\"remoteId\":2490885,\"repositoryType\":\"git\",\""
        		+ "repositoryUrl\":\"https://github.com/hampelratte/svdrp4j.git\",\"score\":25,\"size\":1458,\"starred\":3,\"watched\":3}}";
