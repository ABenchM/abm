...
import de.fraunhofer.abm.builder.docker.ant.steps.ExtractBuildResults;
import de.fraunhofer.abm.builder.docker.ant.steps.RunDockerBuild;
...
public class AntDockerBuilder extends AbstractProjectBuilder {
	 ...
	 private static final String NOT_SET = "NOT_SET";
	    ...
	    public void init(RepositoryDTO repo, File repoDir) {
	        ...
	        Bundle sourceBundle = FrameworkUtil.getBundle(AntDockerBuilder.class);
