...
import de.fraunhofer.abm.builder.docker.gradle.steps.ExtractBuildResults;
import de.fraunhofer.abm.builder.docker.gradle.steps.RunDockerBuild;
import de.fraunhofer.abm.domain.RepositoryDTO;

public class GradleDockerBuilder extends AbstractProjectBuilder {
	 ...
	 private static final String NOT_SET = "NOT_SET";
	    ...
	    public void init(RepositoryDTO repo, File repoDir) {
	        ...
	        Bundle sourceBundle = FrameworkUtil.getBundle(GradleDockerBuilder.class);
